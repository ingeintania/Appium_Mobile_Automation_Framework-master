...
public class AlertViewsTests {
    ...
    public void invokeApp(String runOn, String appPackage, String udid) {
        ...
        if (runOn.equalsIgnoreCase("IOSSimulator")){
            driver = driverFactory.createLocalIOSDriverForSimulator(appPackage, udid, false);
        } else if(runOn.equalsIgnoreCase("AndroidDevice")){
            driver = driverFactory.createLocalIOSDriverForPhysicalDevice(appPackage,udid,"", false);
        } else {
